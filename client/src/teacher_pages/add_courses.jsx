        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="form-group mb-2">
              ...
              <textarea id='s_name' value={c_desc} onChange={(e) => { setCdesc(e.target.value) }} className='form-control my-2 p-3' placeholder='Write about your course in 200 words.' />
            </div>
            <div className="form-group mb-2">
            ...
            <div className="form-group mb-2 mt-2">
              <button type='submit' className='btn btn-primary w-100' onClick={onSaveChanges}>Create New Course</button>
            </div>
          </div>
        </div>
      </div>
