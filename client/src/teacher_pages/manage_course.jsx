                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                            <div class="d-flex mb-3">
                                <Link to={`/Teacher/EditCourses/` + id} class="btn btn-primary">
                                <i class="fa fa-edit text-white me-2"></i>
                                    Edit Course Details</Link>
                            </div>
                            <div class="d-flex mb-3">
                                <Link to={`/Teacher/AddModule/` + id} class="btn btn-primary">
                                <i class="fa fa-add text-white me-2"></i>
                                    Add New Module</Link>
                            </div>
                            <div class="d-flex mb-3">
                                <Link to={`/Teacher/ManageQuiz/` + id} class="btn btn-primary">
                            ...
                            <div className="card-body pb-2">
                                <div className="row">
                                    ...
                                    <div className="col-md-2">
                                        <Link to={`/Teacher/EditModule/` + module._id} className='btn btn-primary w-100 mb-2'>
