...
function view_course() {
    ...
    const [s_enrolled, setSenrolled] = useState();
    ...
    useEffect(() => {
        axios.get("http://127.0.0.1:3001/courses/getcourse/" + id)
            .then(result => {
                ...
                setNom(result.data.num_of_modules);
                setSenrolled(result.data.students_enrolled);
            })
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                            <div class="d-flex mb-3">
                                <Link to={`/Student/TakeQuiz/` + id} class="btn btn-primary">
                            ...
                            <div className="card-body pb-2">
                                <div className="row">
                                    <div className="col-md-10">
                                        <p className='h5 mt-1'>({i += 1}) {module.m_name}</p>
                                    </div>
                                    <div className="col-md-2">
                                        <Link to={`/Student/ViewModule/` + module._id} className='btn btn-primary w-100 mb-2'>
